...
buttons_frame_bg = 'aqua'
hlb_btn_bg = 'grey'
lbl_font = ('Algerian', 13)
entry_font = 'Times 13 bold'
btn_font = ('Gill Sans MT', 13)
# Initializing the GUI window
root = Tk()
root.title('Project Of Expense Tracker')
...
dd1 = OptionMenu(data_entry_frame, MoP, *['Cash', 'Cheque', 'Credit Card', 'Debit Card', 'Gpay','Paytm','PhonePe','Razorpay'])
